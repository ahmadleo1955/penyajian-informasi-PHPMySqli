...
<div class="container">
  ...
  <form method="post">
    <div class="form-group">
      <label for="kendaraandicari">Mencari Kendaraan:</label>
      <input type="text" class="form-control" id="kendaraandicari" name="kendaraandicari" placeholder="Ketik disini ">

    </div>
    
    <button type="submit" class="btn btn-primary" name="bcari">Mulai Pencarian</button>
  </form>
</div>
</body>
</html>
